...
var _shoesView = require("./views/shoes.view");
var _shoesViewDefault = parcelHelpers.interopDefault(_shoesView);
var _shoesController = require("./controller/shoes.controller");
var _shoesControllerDefault = parcelHelpers.interopDefault(_shoesController);
var _shoesService = require("./services/shoes.service");
var _shoesServiceDefault = parcelHelpers.interopDefault(_shoesService);
new (0, _shoesControllerDefault.default)(new (0, _shoesViewDefault.default)(), new (0, _shoesServiceDefault.default)());

},{"./views/shoes.view":"6WbfU","./controller/shoes.controller":"iXLLn","./services/shoes.service":"aDHKj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6WbfU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _registerForm = require("./pages/registerForm");
var _registerFormDefault = parcelHelpers.interopDefault(_registerForm);
var _loginForm = require("./pages/loginForm");
var _loginFormDefault = parcelHelpers.interopDefault(_loginForm);
var _header = require("./layouts/header");
var _headerDefault = parcelHelpers.interopDefault(_header);
var _sidebar = require("./layouts/sidebar");
var _sidebarDefault = parcelHelpers.interopDefault(_sidebar);
var _footer = require("./layouts/footer");
var _footerDefault = parcelHelpers.interopDefault(_footer);
var _pagination = require("./modules/Pagination");
var _paginationDefault = parcelHelpers.interopDefault(_pagination);
var _shoesTable = require("./modules/ShoesTable");
var _shoesTableDefault = parcelHelpers.interopDefault(_shoesTable);
var _productHeader = require("./modules/ProductHeader");
var _productHeaderDefault = parcelHelpers.interopDefault(_productHeader);
var _productDetail = require("./modules/ProductDetail");
var _productDetailDefault = parcelHelpers.interopDefault(_productDetail);
var _productHeader2 = require("./modules/ProductHeader_2");
var _productHeader2Default = parcelHelpers.interopDefault(_productHeader2);
...
var _loginServiceDefault = parcelHelpers.interopDefault(_loginService);
var _registerController = require("../controller/register.controller");
var _registerControllerDefault = parcelHelpers.interopDefault(_registerController);
var _registerView = require("./register.view");
var _registerViewDefault = parcelHelpers.interopDefault(_registerView);
var _registerService = require("../services/register.service");
var _registerServiceDefault = parcelHelpers.interopDefault(_registerService);
var _productsController = require("../controller/products.controller");
var _productsControllerDefault = parcelHelpers.interopDefault(_productsController);
var _productsView = require("./products.view");
...
var _productsServiceDefault = parcelHelpers.interopDefault(_productsService);
var _detailController = require("../controller/detail.controller");
var _detailControllerDefault = parcelHelpers.interopDefault(_detailController);
var _detailView = require("./detail.view");
var _detailViewDefault = parcelHelpers.interopDefault(_detailView);
var _detailService = require("../services/detail.service");
var _detailServiceDefault = parcelHelpers.interopDefault(_detailService);
var _changePasswordController = require("../controller/change-password.controller");
var _changePasswordControllerDefault = parcelHelpers.interopDefault(_changePasswordController);
var _changePasswordView = require("./change-password.view");
var _changePasswordViewDefault = parcelHelpers.interopDefault(_changePasswordView);
var _changePasswordService = require("../services/change-password.service");
var _changePasswordServiceDefault = parcelHelpers.interopDefault(_changePasswordService);
var _allProductView = require("./all-product.view");
var _allProductViewDefault = parcelHelpers.interopDefault(_allProductView);
var _dashboardView = require("./dashboard.view");
var _dashboardViewDefault = parcelHelpers.interopDefault(_dashboardView);
class ShoesView {
    constructor(){
        this.app = document.querySelector("#root");
        this.router = new (0, _routesDefault.default)();
        this.initRoute();
        // add toast container
    ...
    initRoute() {
        this.router.define("/register", (0, _registerFormDefault.default)(), (0, _registerControllerDefault.default), (0, _registerViewDefault.default), (0, _registerServiceDefault.default));
        this.router.define("/login", (0, _loginFormDefault.default)(), (0, _loginControllerDefault.default), (0, _loginViewDefault.default), (0, _loginServiceDefault.default));
        this.router.define("/product/table", this.ProductTable(), (0, _productsControllerDefault.default), (0, _productsViewDefault.default), (0, _productsServiceDefault.default));
        this.router.define("/product/detail", this.ProductDetail(), (0, _detailControllerDefault.default), (0, _detailViewDefault.default), (0, _detailServiceDefault.default), [
            "productId"
        ]);
        this.router.define("/change-password", (0, _changePasswordDefault.default)(), (0, _changePasswordControllerDefault.default), (0, _changePasswordViewDefault.default), (0, _changePasswordServiceDefault.default));
        this.router.define("/dashboard", this.Dashboard(), (0, _dashboardViewDefault.default));
        this.router.define("/product/all", this.ProductAll(), (0, _allProductViewDefault.default));
        this.router.listen();
    }
    ProductTable() {
        ...
        container.innerHTML += (0, _sidebarDefault.default)();
        container.appendChild(main);
        main.innerHTML += (0, _headerDefault.default)();
        main.appendChild(bodyFooter);
        bodyFooter.innerHTML += (0, _productHeaderDefault.default)();
        bodyFooter.innerHTML += (0, _shoesTableDefault.default)();
        bodyFooter.innerHTML += (0, _paginationDefault.default)();
    ...
    ProductDetail() {
        ...
        main.innerHTML += (0, _headerDefault.default)();
        main.appendChild(bodyFooter);
        bodyFooter.innerHTML += (0, _productHeader2Default.default)();
        bodyFooter.innerHTML += (0, _productDetailDefault.default)();
        bodyFooter.innerHTML += (0, _footerDefault.default)();
        return container;
    }
    Dashboard() {
...
},{}],"2uMPf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const loginForm = ()=>{
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1a0Jc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const Header = ()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lNs5j":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const SideBar = ()=>{
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jTm6R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const Footer = ()=>{
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5InSg":[function(require,module,exports) {
// const Pagination = () => {
//     return `
...
const Pagination = ()=>{
    ...
    for(let i = 2; i <= totalButtons; i++)paginationHTML += `<button class="hide pagination-btn">${i}</button>`;
    paginationHTML += `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2UUhk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _tableRow = require("./TableRow");
var _tableRowDefault = parcelHelpers.interopDefault(_tableRow);
const ShoesTable = (products)=>{
    return `
    ...
    <div class="table-content">
      <table>
          ...
          <tbody>
            ${(0, _tableRowDefault.default)(products)}
          </tbody>
      </table>
    </div>
  `;
};
exports.default = ShoesTable;

},{"./TableRow":"cuabV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cuabV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const TableRow = (row)=>{
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jfytd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const ProductHeader = ()=>{
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b4RPc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _productForm = require("./ProductForm");
var _productFormDefault = parcelHelpers.interopDefault(_productForm);
var _productImage = require("./ProductImage");
var _productImageDefault = parcelHelpers.interopDefault(_productImage);
var _productAction = require("./ProductAction");
var _productActionDefault = parcelHelpers.interopDefault(_productAction);
const ProductDetail = ()=>{
    return `
        <div class="product--all">
            <div class = "product">
                ${(0, _productFormDefault.default)()}
                <div class="product-right">
                    ${(0, _productImageDefault.default)()}
                    ${(0, _productActionDefault.default)()}
                </div>
            </div>
        </div>
    `;
...
},{"./ProductForm":"1AWI1","./ProductImage":"3mT1h","./ProductAction":"1GMq1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1AWI1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const ProductForm = ()=>{
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3mT1h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const ProductImage = ()=>{
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1GMq1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const ProductAction = ()=>{
    return `
...
exports.default = ProductAction;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hRxfk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const ProductHeader_2 = ()=>{
    return `
        <div class="table__header">
...
exports.default = ProductHeader_2;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hw5Qm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Router {
    constructor(){
    ...
    listen() {
        ...
        } else console.error("No matching route found.");
    }
    findRoute() {
        const path = window.location.pathname;
    ...
    extractParams(path, pattern, paramNames) {
        ...
        const params = {};
        if (matches && paramNames.length === matches.length - 1) paramNames.forEach((name, index)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1qxxX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iK1ur":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6AVnW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _handleToast = require("./modules/handleToast");
class LoginView {
    constructor(){}
    login(getUser) {
        ...
        this.formLogin?.addEventListener("submit", async (e)=>{
            ...
            if (accepts?.length < 1) {
                (0, _handleToast.createToast)("warning", "You need to agree policy");
                return;
            }
            try {
                ...
                } else (0, _handleToast.createToast)("error", "User not found");
            } catch (err) {
                console.log(err);
            }
        });
...
const createToast = (type = "error", msg = "Error: Fail to implement!")=>{
    ...
    toast.innerHTML = (0, _toastDefault.default)(type, msg);
    if (toastList) {
        toastList.appendChild(toast);
        toast.timeoutId = setTimeout(()=>removeToast(toast), 5000);
    } else console.error('Element with class "notifications" not found.');
};

},{"./Toast":"gh9WG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gh9WG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2xrhV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class LoginService {
    ...
    async getUser(email, password) {
        try {
            const res = await (0, _configDefault.default).get("/users", {
                params: {
                    email,
                    password
                }
            ...
            if (data && data.email === email && data.password === password) return {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jXNV5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eoDRm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RegisterView {
    ...
    register(addUser) {
        ...
        this.form?.addEventListener("submit", (e)=>{
            ...
            if ((0, _validateForm.validateForm)(firstName, lastName, password, email)) addUser(firstName, lastName, email, password).then(()=>{
                (0, _handleToast.createToast)("info", "Register successfully");
                setTimeout(()=>{
                    window.location.href = "/login";
                }, 5000);
            }).catch((err)=>{
                console.error(err);
                (0, _handleToast.createToast)("error", "Error registering user");
            });
        });
    }
}
...
parcelHelpers.export(exports, "validateShoes", ()=>validateShoes);
var _handleToast = require("../views/modules/handleToast");
function validateForm(firstName = "", lastName = "", password = "", email = "") {
    const validations = [
        ...
        },
        {
            ...
            errorMessage: "Password must be at least 8 characters with at least one uppercase, one lowercase, one special character, and a number."
        },
        {
            field: email.trim(),
            regex: /^(([^<>()\[\]\.,;:\s@\"]+(\.[^<>()\[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i,
    ...
    validations.forEach((validation)=>{
        switch(true){
            case !validation.field:
                (0, _handleToast.createToast)("warning", validation.errorMessage);
                isValid = false;
                break;
    ...
    passwordInputs.forEach(function(input) {
        input.addEventListener("keyup", function() {
            ...
            if (p.value.length >= 8) {
                ...
                var numberRegex = /\d/;
                var isValid = upperCaseRegex.test(p.value) && lowerCaseRegex.test(p.value) && specialCharacterRegex.test(p.value) && numberRegex.test(p.value);
                if (!isValid) document.getElementById("valid").innerHTML = "Password does not meet the requirements";
                else document.getElementById("valid").innerHTML = "";
                var strength = "weak";
                if (p.value.length > 5 && p.value.match(/\d+/g)) strength = "medium";
                if (p.value.length > 6 && p.value.match(/[^\w\s]/gi)) strength = "strong";
...
function validateFormPassword() {
    ...
    if (!password.trim() || !confirmPassword.trim()) {
        (0, _handleToast.createToast)("warning", "Please fill in all fields.");
        return false;
    }
    return true;
}
...
class ProductsView {
    ...
    bindTable(shoes) {
        ...
        if (shoes && shoes.length) tableBody.innerHTML = (0, _tableRowDefault.default)(shoes);
        else {
            tableBody.innerHTML = "";
    ...
    logout() {
        ...
        this.selects?.addEventListener("change", (e)=>{
            ...
            if (value === "changePassword") window.location.pathname = "/change-password";
        });
    }
}
...
class ProductsService {
    ...
    async getAllShoes() {
        try {
            let { data } = await (0, _configDefault.default).get("/shoes");
            if (data) {
                this.shoes = await data.map((shoes)=>new (0, _shoesModelDefault.default)(shoes));
                return this.shoes;
            }
        } catch (error) {
            (0, _handleToast.createToast)("error", "Error fetching all shoes");
        }
    }
    async searchShoes(name) {
        try {
            const { data } = await (0, _configDefault.default).get("/shoes", {
                params: {
                    q: name
                }
            });
...
var _skuIdDefault = parcelHelpers.interopDefault(_skuId);
class Shoes {
    constructor({ id, brand, name, category, status, image, amount, price, salePrice, description } = {}){
        this.id = id;
        this.brand = brand;
        this.name = name;
...
},{"../helper/sku_id":"7vY3Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7vY3Q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function generateID() {
    const randomDigits = Array.from({
        length: 5
    }, ()=>Math.floor(Math.random() * 5)).join("");
    return `#${randomDigits}`;
}
exports.default = generateID;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fzYuG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class DetailView {
        ...
        addShoesButton?.addEventListener("click", async ()=>{
            ...
            if ((0, _validateForm.validateShoes)()) {
                ...
                fetch("https://api.imgbb.com/1/upload?key=12bf5830553fd071836060cc5f97b484", {
                    ...
                    addShoes(new (0, _shoesModelDefault.default)({
                        brand,
                        name,
                        category,
                        status: "",
                        ...
                        (0, _handleToast.createToast)("info", "Add shoes successfully");
                        setTimeout(()=>{
                            window.location.href = "/product/table";
                        }, 3000);
                    }).catch((err)=>{
                        console.error(err);
                        (0, _handleToast.createToast)("error", "Error adding shoes");
                    });
                    const storedUser = localStorage.getItem("users");
                    const user = storedUser ? JSON.parse(storedUser) : null;
    ...
    cancelShoes() {
        ...
        if (cancelShoesButton) cancelShoesButton.addEventListener("click", ()=>{
            this.resetForm();
        });
    }
    resetForm() {
        ...
        updateShoesButton?.addEventListener("click", ()=>{
            ...
            if ((0, _validateForm.validateShoes)()) {
                ...
                fetch("https://api.imgbb.com/1/upload?key=12bf5830553fd071836060cc5f97b484", {
                    ...
                    update(id, new (0, _shoesModelDefault.default)({
                        id,
                        brand,
                        category,
                        description,
                    ...
                    (0, _handleToast.createToast)("info", "Update shoes succesfully");
                    setTimeout(()=>{
                        window.location.href = "/product/table";
                    }, 2000);
                });
            } else (0, _handleToast.createToast)("error", "Error updating table");
        });
    }
    uploadImage() {
        const image = document.getElementById("imageUpload");
...
class DetailService {
    ...
    async getShoes(id) {
        try {
            ...
            (0, _handleToast.createToast)("error", "Error fetching shoes by id");
        }
    }
    async addShoes(shoes) {
        try {
            await (0, _configDefault.default).post("/shoes", shoes);
        } catch (error) {
            (0, _handleToast.createToast)("error", "Error adding shoes");
            console.log(error);
        }
    ...
    async addNoti(id, notifications) {
        try {
            ...
            (0, _handleToast.createToast)("error", "Error fetching user to notification");
        }
    }
    async deleteShoes(id) {
        try {
            await (0, _configDefault.default).delete(`/shoes/${id}`, {
                params: {
                    id
                }
            });
        } catch (error) {
            (0, _handleToast.createToast)("error", "Error deleting shoes");
        }
    }
    async updateShoes(id, newShoes) {
        try {
            await (0, _configDefault.default).patch(`/shoes/${id}`, newShoes);
        } catch (error) {
            (0, _handleToast.createToast)("error", "Error updating shoes");
            console.log(error);
        }
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8vJKB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _validateForm = require("../helper/validateForm");
var _validateFormDefault = parcelHelpers.interopDefault(_validateForm);
var _handleToast = require("./modules/handleToast");
class ChangePasswordView {
    ...
    changePassword(updatePassword) {
        ...
        this.form?.addEventListener("submit", (e)=>{
            ...
            const storedUser = localStorage.getItem("users");
            const user = storedUser ? JSON.parse(storedUser) : null;
            if ((0, _validateFormDefault.default)(user.firstName, user.lastName, password, user.email)) {
                console.log(password, repassword);
                updatePassword(user.firstName, user.lastName, repassword, user.email, user.id).then(()=>{
                    (0, _handleToast.createToast)("info", "Change password sucessfully");
                    setTimeout(()=>{
                        window.location.pathname = "/product/table";
                    }, 2000);
                }).catch((err)=>{
                    console.error(err);
                    (0, _handleToast.createToast)("warning", "Error. Please enter again");
                });
            }
        });
    }
...
exports.default = ShoesController;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aDHKj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../api/config");
var _configDefault = parcelHelpers.interopDefault(_config);
...
class ShoesService {
    ...
    async updateStatus(id, status) {
        try {
            await (0, _configDefault.default).patch(`/shoes/${id}`, {
                status
            });
        } catch (err) {
...
exports.default = ShoesService;

},{"../api/config":"41BLM","../views/modules/handleToast":"7KjUu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3lsJq","bNKaB"], "bNKaB", "parcelRequire5813")
